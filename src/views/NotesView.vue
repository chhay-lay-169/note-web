...
import { Search, Plus, SortAsc, StickyNote, Loader2, LogOut } from '@lucide/vue';
                ...
                <div class="w-full lg:w-80 flex flex-col">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center text-xs text-gray-500">
                            ...
                            <select :value="noteStore.sortBy" @change="handleSort" class="bg-transparent border-none focus:ring-0 cursor-pointer font-medium p-0">
